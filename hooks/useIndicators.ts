...
export type IndicatorCategory = 'demograficos' | 'territoriales' | 'programa' | 'calidad-dato' | 'vulnerabilidad' | 'cobertura-temporal' | 'nivel-educativo' | 'desempeno-centro' | 'centros-sin-menores' | 'desercion';
