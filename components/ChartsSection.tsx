...
import { DEFAULT_VISIBLE_WIDGET_IDS } from '../constants/widgets';
...
export const ChartsSection: React.FC<ChartsSectionProps> = ({ data, selectedProvince, selectedMunicipio, showLabels = false, visibleWidgetIds = DEFAULT_VISIBLE_WIDGET_IDS }) => {
  ...
  return (
    <div className="space-y-6 mb-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {visibleSet.has('ubicacion') && <LocationChart data={data} showLabels={showLabels} />}
        {visibleSet.has('genero') && <GenderChart data={data} showLabels={showLabels} />}
        {visibleSet.has('edad') && <AgeChart data={data} showLabels={showLabels} />}
        {visibleSet.has('estado-participacion') && <StatusChart data={data} showLabels={showLabels} />}

        {visibleSet.has('vulnerabilidades') && (
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        ...
        {visibleSet.has('programas-sociales') && (
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
